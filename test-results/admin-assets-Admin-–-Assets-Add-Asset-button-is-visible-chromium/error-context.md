...
- Name: admin-assets.spec.js >> Admin – Assets >> "Add Asset" button is visible
- Location: tests\admin-assets.spec.js:25:3
...
Locator: getByRole('button', { name: /add asset|new asset|\+ asset/i }).or(getByText(/add asset|\+ asset/i)).first()
Expected: visible
Timeout: 15000ms
